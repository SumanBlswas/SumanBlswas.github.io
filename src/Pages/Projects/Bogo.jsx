...
import BogoImage from "./Image/Bogo.png";
...
const Bogo = () => {
  const handleBogo = () => {
    window.open("https://bogo-app.netlify.app/");
  };
  const handleGithubBogo = () => {
    window.open("https://github.com/SumanBlswas/Bogo-App");
  };
